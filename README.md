...
https://raw.githubusercontent.com/ftriquet/pi-claude-auth/main/installation.md
```
...
```
npm:@ftriquet/pi-claude-auth (user)
  Extensions
    [x] src/index.ts
```
...
| Package not updating               | Run `pi update npm:@ftriquet/pi-claude-auth`                                                                     |
